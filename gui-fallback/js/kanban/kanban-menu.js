...
const KanbanMenuConfig = createHubMenu({
    ...
    defaultMenu: [
        ...
        { id: 'kanban-step18-proof', label: 'Write Detail Proof', icon: KanbanActionIcons.shield, pageLabel: 'Write Child And Detail Proof', parent: 'kanban-layout', order: 18, fn: 'kanban.step18ProofWrite', activeOn: ['kanban'] },
        { id: 'kanban-step19-proof', label: 'Write Scoped Proof', icon: KanbanActionIcons.shield, pageLabel: 'Write Scoped Issue And ToDo Proof', parent: 'kanban-layout', order: 19, fn: 'kanban.step19ProofWrite', activeOn: ['kanban'] },
        { id: 'kanban-safe-checks', label: 'Safe Checks', icon: KanbanActionIcons.shield, pageLabel: 'Kanban Safe Checks', parent: 'kanban-layout', order: 20, fn: 'kanban.safeChecks', activeOn: ['kanban'] },
    ],
});

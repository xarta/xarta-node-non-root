...
const KanbanMenuConfig = createHubMenu({
    ...
    defaultMenu: [
        ...
        { id: 'kanban-move-left', label: 'Move Left', icon: KanbanActionIcons.left, pageLabel: 'Move Selected Left', parent: 'kanban-layout', order: 9, fn: 'kanban.moveLeft', activeOn: ['kanban'] },
        { id: 'kanban-move-right', label: 'Move Right', icon: KanbanActionIcons.right, pageLabel: 'Move Selected Right', parent: 'kanban-layout', order: 10, fn: 'kanban.moveRight', activeOn: ['kanban'] },
        { id: 'kanban-archive', label: 'Archive', icon: KanbanActionIcons.archive, pageLabel: 'Archive Selected Item', parent: 'kanban-layout', order: 11, fn: 'kanban.archive', activeOn: ['kanban'] },
        { id: 'kanban-step18-proof', label: 'Proof Write', icon: KanbanActionIcons.shield, pageLabel: 'Proof Child And Detail Write', parent: 'kanban-layout', order: 12, fn: 'kanban.step18ProofWrite', activeOn: ['kanban'] },
        { id: 'kanban-safe-checks', label: 'Safe Checks', icon: KanbanActionIcons.shield, pageLabel: 'Kanban Safe Checks', parent: 'kanban-layout', order: 13, fn: 'kanban.safeChecks', activeOn: ['kanban'] },
    ],
});

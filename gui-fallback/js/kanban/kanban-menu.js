...
const KanbanMenuConfig = createHubMenu({
    ...
    defaultMenu: [
        ...
        { id: 'kanban-up-board', label: 'Up Board', icon: KanbanActionIcons.up, pageLabel: 'Open Parent Board', parent: 'kanban-layout', order: 3, fn: 'kanban.openUpBoard', activeOn: ['kanban'] },
        { id: 'kanban-child-board', label: 'Child Board', icon: KanbanActionIcons.board, pageLabel: 'Open Selected Child Board', parent: 'kanban-layout', order: 4, fn: 'kanban.openChildBoard', activeOn: ['kanban'] },
        { id: 'kanban-detail', label: 'Detail', icon: KanbanActionIcons.detail, pageLabel: 'Selected Item Detail', parent: 'kanban-layout', order: 5, fn: 'kanban.openDetail', activeOn: ['kanban'] },
        { id: 'kanban-add-child', label: 'Add Child', icon: KanbanActionIcons.newItem, pageLabel: 'Add Child Item', parent: 'kanban-layout', order: 6, fn: 'kanban.addChild', activeOn: ['kanban'] },
        { id: 'kanban-add-issue', label: 'Add Issue', icon: KanbanActionIcons.issue, pageLabel: 'Add Issue To Item', parent: 'kanban-layout', order: 7, fn: 'kanban.addIssue', activeOn: ['kanban'] },
        { id: 'kanban-add-todo', label: 'Add ToDo', icon: KanbanActionIcons.todo, pageLabel: 'Add ToDo To Item', parent: 'kanban-layout', order: 8, fn: 'kanban.addTodo', activeOn: ['kanban'] },
        { id: 'kanban-scoped-issues', label: 'Scoped Issues', icon: KanbanActionIcons.issue, pageLabel: 'Selected Scoped Issues', parent: 'kanban-layout', order: 9, fn: 'kanban.scopedIssues', activeOn: ['kanban'] },
        { id: 'kanban-scoped-todos', label: 'Scoped ToDos', icon: KanbanActionIcons.todo, pageLabel: 'Selected Scoped ToDos', parent: 'kanban-layout', order: 10, fn: 'kanban.scopedTodos', activeOn: ['kanban'] },
        ...
        { id: 'kanban-step18-proof', label: 'Proof Write', icon: KanbanActionIcons.shield, pageLabel: 'Proof Child And Detail Write', parent: 'kanban-layout', order: 14, fn: 'kanban.step18ProofWrite', activeOn: ['kanban'] },
        { id: 'kanban-step19-proof', label: 'Scoped Proof', icon: KanbanActionIcons.shield, pageLabel: 'Proof Scoped Issue And ToDo Write', parent: 'kanban-layout', order: 15, fn: 'kanban.step19ProofWrite', activeOn: ['kanban'] },

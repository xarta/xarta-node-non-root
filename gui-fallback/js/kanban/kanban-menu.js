...
const KanbanMenuConfig = createHubMenu({
    ...
    defaultMenu: [
        ...
        { id: 'kanban-root-board', label: 'Open Root', icon: KanbanActionIcons.board, pageLabel: 'Open Root Board', parent: 'kanban-layout', order: 2, fn: 'kanban.openRootBoard', activeOn: ['kanban'] },
        { id: 'kanban-up-board', label: 'Open Parent', icon: KanbanActionIcons.up, pageLabel: 'Open Parent Board', parent: 'kanban-layout', order: 3, fn: 'kanban.openUpBoard', activeOn: ['kanban'] },
        { id: 'kanban-child-board', label: 'Open Child', icon: KanbanActionIcons.board, pageLabel: 'Open Selected Child Board', parent: 'kanban-layout', order: 4, fn: 'kanban.openChildBoard', activeOn: ['kanban'] },
        { id: 'kanban-detail', label: 'Open Detail', icon: KanbanActionIcons.detail, pageLabel: 'Open Selected Item Detail', parent: 'kanban-layout', order: 5, fn: 'kanban.openDetail', activeOn: ['kanban'] },
        { id: 'kanban-add-child', label: 'New Child', icon: KanbanActionIcons.newItem, pageLabel: 'New Child Item', parent: 'kanban-layout', order: 6, fn: 'kanban.addChild', activeOn: ['kanban'] },
        { id: 'kanban-add-issue', label: 'New Issue', icon: KanbanActionIcons.issue, pageLabel: 'New Issue For Item', parent: 'kanban-layout', order: 7, fn: 'kanban.addIssue', activeOn: ['kanban'] },
        { id: 'kanban-add-todo', label: 'New ToDo', icon: KanbanActionIcons.todo, pageLabel: 'New ToDo For Item', parent: 'kanban-layout', order: 8, fn: 'kanban.addTodo', activeOn: ['kanban'] },
        { id: 'kanban-scoped-issues', label: 'Show Issues', icon: KanbanActionIcons.issue, pageLabel: 'Show Selected Scoped Issues', parent: 'kanban-layout', order: 9, fn: 'kanban.scopedIssues', activeOn: ['kanban'] },
        { id: 'kanban-scoped-todos', label: 'Show ToDos', icon: KanbanActionIcons.todo, pageLabel: 'Show Selected Scoped ToDos', parent: 'kanban-layout', order: 10, fn: 'kanban.scopedTodos', activeOn: ['kanban'] },
        { id: 'kanban-move-left', label: 'Move Left', icon: KanbanActionIcons.left, pageLabel: 'Move Selected Left', parent: 'kanban-layout', order: 11, fn: 'kanban.moveLeft', activeOn: ['kanban'] },
        { id: 'kanban-move-right', label: 'Move Right', icon: KanbanActionIcons.right, pageLabel: 'Move Selected Right', parent: 'kanban-layout', order: 12, fn: 'kanban.moveRight', activeOn: ['kanban'] },
        { id: 'kanban-archive', label: 'Archive', icon: KanbanActionIcons.archive, pageLabel: 'Archive Selected Item', parent: 'kanban-layout', order: 13, fn: 'kanban.archive', activeOn: ['kanban'] },
        { id: 'kanban-step18-proof', label: 'Write Detail Proof', icon: KanbanActionIcons.shield, pageLabel: 'Write Child And Detail Proof', parent: 'kanban-layout', order: 14, fn: 'kanban.step18ProofWrite', activeOn: ['kanban'] },
        { id: 'kanban-step19-proof', label: 'Write Scoped Proof', icon: KanbanActionIcons.shield, pageLabel: 'Write Scoped Issue And ToDo Proof', parent: 'kanban-layout', order: 15, fn: 'kanban.step19ProofWrite', activeOn: ['kanban'] },
        { id: 'kanban-safe-checks', label: 'Safe Checks', icon: KanbanActionIcons.shield, pageLabel: 'Kanban Safe Checks', parent: 'kanban-layout', order: 16, fn: 'kanban.safeChecks', activeOn: ['kanban'] },
    ],
});

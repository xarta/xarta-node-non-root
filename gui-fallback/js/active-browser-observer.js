  ...
  function _stableAutomationKey(automation) {
    ...
    return {
      ...
      kanban: {
        ...
        automation_proposal_surface_schema: kanban.automation_proposal_surface_schema || '',
        automation_proposal_inbox_item_id: kanban.automation_proposal_inbox_item_id || '',
        automation_proposal_outbox_item_id: kanban.automation_proposal_outbox_item_id || '',
        automation_proposal_inbox_entry_count: Number(kanban.automation_proposal_inbox_entry_count || 0),
        automation_proposal_outbox_entry_count: Number(kanban.automation_proposal_outbox_entry_count || 0),
        automation_proposal_inbox_open_count: Number(kanban.automation_proposal_inbox_open_count || 0),
        automation_proposal_inbox_actionable_count: Number(kanban.automation_proposal_inbox_actionable_count || 0),
        automation_proposal_inbox_history_count: Number(kanban.automation_proposal_inbox_history_count || 0),
        automation_proposal_inbox_superseded_count: Number(kanban.automation_proposal_inbox_superseded_count || 0),
        automation_proposal_inbox_obsolete_count: Number(kanban.automation_proposal_inbox_obsolete_count || 0),
        automation_proposal_outbox_processed_count: Number(kanban.automation_proposal_outbox_processed_count || 0),
        automation_proposal_response_busy: !!kanban.automation_proposal_response_busy,
        automation_proposal_response_busy_item_id: kanban.automation_proposal_response_busy_item_id || '',
        automation_proposal_response_error_count: Number(kanban.automation_proposal_response_error_count || 0),
      },
      email: {
        loaded: !!email.loaded,

...
const DaveMenuConfig = createHubMenu({
    ...
    defaultMenu: [
        ...
        { id: 'calendar-view-year', label: 'Mode Year', icon: DaveActionIcons.calendar, pageLabel: 'Calendar Year Mode', parent: 'dave-layout', order: 2, fn: 'calendar.viewYear', activeOn: ['calender'] },
        { id: 'calendar-view-month', label: 'Mode Month', icon: DaveActionIcons.calendar, pageLabel: 'Calendar Month Mode', parent: 'dave-layout', order: 3, fn: 'calendar.viewMonth', activeOn: ['calender'] },
        { id: 'calendar-mode-day', label: 'Mode Day', icon: DaveActionIcons.calendar, pageLabel: 'Calendar Day Detail', parent: 'dave-layout', order: 4, fn: 'calendar.modeDay', activeOn: ['calender'] },
        { id: 'calendar-mode-week', label: 'Mode Week', icon: DaveActionIcons.calendar, pageLabel: 'Calendar Week Detail', parent: 'dave-layout', order: 5, fn: 'calendar.modeWeek', activeOn: ['calender'] },
        { id: 'calendar-filter-all', label: 'Filter All', icon: DaveActionIcons.filter, pageLabel: 'Calendar All Sources', parent: 'dave-layout', order: 6, fn: 'calendar.filterAll', activeOn: ['calender'] },
        { id: 'calendar-filter-tasks', label: 'Filter Tasks', icon: DaveActionIcons.filter, pageLabel: 'Calendar Tasks', parent: 'dave-layout', order: 7, fn: 'calendar.filterTasks', activeOn: ['calender'] },
        { id: 'calendar-filter-work', label: 'Filter Work', icon: DaveActionIcons.filter, pageLabel: 'Calendar Work', parent: 'dave-layout', order: 8, fn: 'calendar.filterWork', activeOn: ['calender'] },
        { id: 'calendar-edit-event', label: 'Edit Event', icon: DaveActionIcons.edit, pageLabel: 'Edit Calendar Event', parent: 'dave-layout', order: 9, fn: 'calendar.editSelected', activeOn: ['calender'] },
        { id: 'calendar-open-source', label: 'Open Source', icon: DaveActionIcons.document, pageLabel: 'Calendar Source Detail', parent: 'dave-layout', order: 10, fn: 'calendar.openSource', activeOn: ['calender'] },
        { id: 'calendar-link-diary', label: 'Link Diary', icon: DaveActionIcons.link, pageLabel: 'Open Diary For Date', parent: 'dave-layout', order: 11, fn: 'calendar.linkDiary', activeOn: ['calender'] },
        { id: 'calendar-create-task', label: 'New Task', icon: DaveActionIcons.newEntry, pageLabel: 'New Calendar Task', parent: 'dave-layout', order: 12, fn: 'calendar.createTask', activeOn: ['calender'] },
        { id: 'calendar-connect-work', label: 'Link Work', icon: DaveActionIcons.link, pageLabel: 'Link Calendar Event To Work', parent: 'dave-layout', order: 13, fn: 'calendar.linkWorkItem', activeOn: ['calender'] },
        { id: 'calendar-explain', label: 'Explain', icon: DaveActionIcons.explain, pageLabel: 'Explain Calendar State', parent: 'dave-layout', order: 14, fn: 'calendar.explainSelection', activeOn: ['calender'] },
        { id: 'calendar-safe-checks', label: 'Safe Checks', icon: DaveActionIcons.shield, pageLabel: 'Calendar Safe Checks', parent: 'dave-layout', order: 15, fn: 'calendar.safeChecks', activeOn: ['calender'] },

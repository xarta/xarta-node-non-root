...
const DaveMenuConfig = createHubMenu({
    ...
    contextMenuColumns(activeId, items) {
        if (activeId !== 'calender') return null;
    ...
    defaultMenu: [
        ...
        { id: 'diary-run-summary', label: 'Generate Summary', icon: DaveActionIcons.run, pageLabel: 'Generate Diary Summary', parent: 'dave-layout', order: 2, fn: 'diary.generateSummary', activeOn: ['diary'] },
        { id: 'diary-browse-folder', label: 'Open Day Folder', icon: DaveActionIcons.folder, pageLabel: 'Open Day Folder', parent: 'dave-layout', order: 3, fn: 'diary.openDayFolder', activeOn: ['diary'] },
        { id: 'diary-browse-ledger', label: 'Open Source', icon: DaveActionIcons.document, pageLabel: 'Open Source Ledger', parent: 'dave-layout', order: 4, fn: 'diary.openSourceLedger', activeOn: ['diary'] },
        ...
        { id: 'diary-filter-sources', label: 'Filter Sources', icon: DaveActionIcons.filter, pageLabel: 'Filter Diary Source Records', parent: 'dave-layout', order: 7, fn: 'diary.filterSources', activeOn: ['diary'] },
        ...
        { id: 'diary-connect-work', label: 'Link Work', icon: DaveActionIcons.link, pageLabel: 'Link Diary Event To Work', parent: 'dave-layout', order: 10, fn: 'diary.linkWorkItem', activeOn: ['diary'] },

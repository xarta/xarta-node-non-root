...
const DaveMenuConfig = createHubMenu({
    ...
    defaultMenu: [
        ...
        { id: 'calendar-mode-day', label: 'Mode Day', icon: DaveActionIcons.calendar, pageLabel: 'Calendar Day Mode', parent: 'dave-layout', order: 2, fn: 'calendar.modeDay', activeOn: ['calender'] },
        { id: 'calendar-mode-week', label: 'Mode Week', icon: DaveActionIcons.calendar, pageLabel: 'Calendar Week Mode', parent: 'dave-layout', order: 3, fn: 'calendar.modeWeek', activeOn: ['calender'] },
        ...
        { id: 'calendar-create-task', label: 'New Task', icon: DaveActionIcons.newEntry, pageLabel: 'New Calendar Task', parent: 'dave-layout', order: 10, fn: 'calendar.createTask', activeOn: ['calender'] },
        { id: 'calendar-connect-work', label: 'Link Work', icon: DaveActionIcons.link, pageLabel: 'Link Calendar Event To Work', parent: 'dave-layout', order: 11, fn: 'calendar.linkWorkItem', activeOn: ['calender'] },

...
(function (root, factory) {
  ...
  const RULES = [
    ...
    { key: 'chat-voice-mode', rank: 19, patterns: [/chat-fn-voice-mode/, /\bvoice mode\b/] },
    { key: 'chat-noise-tests', rank: 20, patterns: [/chat-fn-noise-tests/, /\bnoise tests\b/] },
    { key: 'chat-wake-dev', rank: 21, patterns: [/chat-fn-wake-dev/, /\bwake dev\b/] },
    { key: 'chat-wake-queues', rank: 22, patterns: [/chat-fn-wake-queues/, /\bwake queue dev\b/, /\bwake queues\b/] },
    { key: 'chat-notifier', rank: 23, patterns: [/chat-fn-notifier/, /\bnotification controls\b/] },
